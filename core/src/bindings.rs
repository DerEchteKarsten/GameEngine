...
pub struct BvhCullBindings {
    pub stack: BufferSlice<u64>,
    pub variables: BufferSlice<TraversalVariables>,
}
...
impl Binding for CBvhCullBindings {
    ...
    fn from_cpu_binding(bindings: &Self::CpuBinding) -> Self {
        Self {
            stack: bindings.stack.gpu_address() as u64,
variables: bindings.variables.gpu_address() as u64,
        }
    }
    ...
    fn resources(
        ...
        vec![
            (ResourceHandle::Buffer(bindings.stack.into()),
ResourceState {
    stages,
...
(ResourceHandle::Buffer(bindings.variables.into()),
ResourceState {
    stages,
    access: AccessFlags2::SHADER_STORAGE_READ,
